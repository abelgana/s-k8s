...
token=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -X POST -d "{\"password\": \"etcd\"}" https://127.0.0.1:8200/v1/auth/userpass/login/etcd |  jq -r ."auth.client_token")

etcdPems=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -H "X-Vault-Token: $token" -X POST -d @vault/issueCertMaster1.json https://127.0.0.1:8200/v1/etcd/issue/etcd)
...
token=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -X POST -d "{\"password\": \"kube\"}" https://127.0.0.1:8200/v1/auth/userpass/login/kube-master |  jq -r ."auth.client_token")

kubeAdminPems=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -H "X-Vault-Token: $token" -X POST -d @vault/genCertKubeAdmin.json https://127.0.0.1:8200/v1/kube/issue/kube-master)
...
apiserverPems=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -H "X-Vault-Token: $token" -X POST -d @vault/genCertKubeMaster.json https://127.0.0.1:8200/v1/kube/issue/kube-master)
...
kubeScheduler=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -H "X-Vault-Token: $token" -X POST -d @vault/genCertKubeMaster.json https://127.0.0.1:8200/v1/kube/issue/kube-master)
...
kubeControllerManagerPems=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -H "X-Vault-Token: $token" -X POST -d @vault/genCertKubeMaster.json https://127.0.0.1:8200/v1/kube/issue/kube-master)
...
token=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -X POST -d "{\"password\": \"kube\"}" https://127.0.0.1:8200/v1/auth/userpass/login/kube-node |  jq -r ."auth.client_token")

kubeNodePems=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -H "X-Vault-Token: $token" -X POST -d @vault/genCertKubeNodeMaster1.json https://127.0.0.1:8200/v1/kube/issue/kube-node)
...
token=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -X POST -d "{\"password\": \"kube\"}" https://127.0.0.1:8200/v1/auth/userpass/login/kube-proxy |  jq -r ."auth.client_token")

kubeProxyPems=$(curl --cacert /tmp/home/vault/ssl/vault1/ca.pem -H "Content-Type: application/json" -H "X-Vault-Token: $token" -X POST -d @vault/genCertKubeProxyMaster1.json https://127.0.0.1:8200/v1/kube/issue/kube-proxy)
...
#cp k8sConfig/calico-kubeconfig1.yaml /etc/cni/net.d/10-calico.conflist
...
#cp /etc/ssl/etcd/ssl/etcd.pem /etc/calico/certs/cert.crt
#cp /etc/ssl/etcd/ssl/etcd-key.pem /etc/calico/certs/key.pem
#cp calico/calicoctl-container /opt/bin/calicoctl
...
#
#cp calico/calico-config.yml /etc/kubernetes
#cp calico/calico-node.yml /etc/kubernetes
#cp calico/calico-node-sa.yml /etc/kubernetes
#cp calico/calico-cr.yml /etc/kubernetes
#cp calico/calico-crb.yml /etc/kubernetes
